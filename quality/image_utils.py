...
def store_image(label_path: str, source_image_path: str, target_image_path: str, copy_to_subfolder: bool):
    if copy_to_subfolder and should_copy_subfolder_to_path(label_path, source_image_path):

...
from model_selection import supported_joycaption_models, supported_clip_models
...
def setup_config(model_type: str = "alpha"):
    ...
    if model_type == "alpha":
        ...
        raise Exception(f"model_type {model_type} is not supported, available: {[*supported_joycaption_models(), *supported_clip_models()]}")